...
namespace ScoreSaber.UI.Elements.Profile {
    ...
    internal class ProfileDetailViewTypeHandler : TypeHandler<ProfileDetailView> {
        ...
        public override Dictionary<string, Action<ProfileDetailView, string>> Setters =>
            new Dictionary<string, Action<ProfileDetailView, string>> {
        ...
        public override void HandleTypeAfterParse(BSMLParser.ComponentTypeWithData componentType,
            BSMLParserParams parserParams) {
            base.HandleTypeAfterParse(componentType, parserParams);
            try {
                ProfileDetailView profile = componentType.component as ProfileDetailView;
                Transform parent = profile.profileModalRoot.transform.parent;
